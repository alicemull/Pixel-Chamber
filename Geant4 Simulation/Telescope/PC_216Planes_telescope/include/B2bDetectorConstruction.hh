...
private:
  ...
  // G4int fnoSensors;
  // G4int fnoBigSensors;
  G4LogicalVolume** fPixel;          // pointer to the logic Pixel
  G4LogicalVolume** fLogicSensor;    // pointer to the logical Chamber
  G4LogicalVolume** fLogicBigSensor; // pointer to the logic Pixel

  G4LogicalVolume** fPixelTrk;
  G4LogicalVolume** fLogicChip;
  G4LogicalVolume** fLogicBigChip;
  G4LogicalVolume*  fLogicStave;
  G4LogicalVolume*  fTrackerLV;

  G4Material*        fSensorMaterial;  // pointer to the chamber material

  G4UserLimits*      fStepLimit;       // pointer to user step limits
  B2bDetectorMessenger*  fMessenger;   // detector messenger

  //  static G4ThreadLocal G4MagneticField* fMagField;
