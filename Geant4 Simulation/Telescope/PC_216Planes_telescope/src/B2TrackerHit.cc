  ...
  : G4VHit()
{
  ...
  fPixelTrkNb   = right.fPixelTrkNb;
  fChipNb  = right.fChipNb;
  fEdep      = right.fEdep;
  fEtot      = right.fEtot;
  fPos       = right.fPos;
  fPartName  = right.fPartName;
  fPartPDG   = right.fPartPDG;
  fPixelTrkPos  = right.fPixelTrkPos;
  fEventID   = right.fEventID;
  fPixelTrkPosx = right.fPixelTrkPosx;
  fPixelTrkPosy = right.fPixelTrkPosy;
  fPixelTrkPosz = right.fPixelTrkPosz;
  fVertexPosx = right.fVertexPosx;
  fVertexPosy = right.fVertexPosy;
  fVertexPosz = right.fVertexPosz;
  fBigChipNb  = right.fBigChipNb;
...
void B2TrackerHit::Print()
{
  /* G4cout
     << " TrackID: " << fTrackID 
     << " EventID: " << fEventID 
     << " PixelTrkNb: " << fPixelTrkNb 
     << " Position PixelTrk: "
     << std::setw(7) << G4BestUnit( fPixelTrkPos,"Length")
     << " Particle: " << fPartName
     << " Particle PDG Code: " << fPartPDG
     << " ChipNb: " << fChipNb
     << " BigChipNb: " << fBigChipNb
     << " Edep: "
