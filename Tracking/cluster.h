...
class Datapoint : public TObject
{
	public:
		...
		bool isNoise(int NB_MIN=2, int NB_MAX=4);
		int distance(Datapoint *p2);
		bool isValid(int NB_MIN=2, int NB_MAX=4);
...
class Cluster : public TObject
{
	public:
		...
		bool isNeighbour(Datapoint *p, int NB_MIN=2, int NB_MAX=4);
		void makeGraph();
		void fitCluster();
...
class PixelChamberEvent : public TObject
{
	public:
		...
		int findClusters(int NB_MIN=2, int NB_MAX=4);
